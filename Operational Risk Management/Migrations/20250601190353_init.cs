        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenDaysBeforePeriodEnd = table.Column<int>(type: "int", nullable: false),
                    CloseDaysAfterPeriodEnd = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KRIType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RfNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Process = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RiskArea = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IndicatorName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FrequencyOfReview = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalProcess = table.Column<int>(type: "int", nullable: true),
                    TolerableBreaches = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Breaches = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WindowLocked = table.Column<bool>(type: "bit", nullable: false),
                    WindowLockReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WindowOverride = table.Column<bool>(type: "bit", nullable: true),
                    WindowOverrideBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WindowOverrideDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submissions_Indicators_IndicatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_IndicatorId",
                table: "Submissions",
                column: "IndicatorId");
